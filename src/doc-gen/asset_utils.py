...
Util            normalized_team.setdefault('termination_keyword', workflow_config.get('termination_keyword'))
            
            # Set defaults for required fields
            normalized_team.setdefault('labeled_inputs', [])
            normalized_team.setdefault('depends_on', None)
            
            # Validationions for workflow loading and team normalization, 
    ...
    def load_workflow(workflow_file_path: str) -> List[TeamConfig]:
        ...
        for team_data in workflow_config['teams']:
            ...
            team_config = TeamConfig(
                ...
                labeled_inputs=normalized_team.get('labeled_inputs', []),
